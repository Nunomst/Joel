export function aboutus () {
    ...
    <div class="container">
      ...
      <div class="aboutus-item">
        <div class="aboutus-img" data-aos="fade-right" data-aos-delay="900">
          <img src="assets/img5.jpg" alt="">
        </div>
        <div class="aboutus-description-left" data-aos="fade-left" data-aos-delay="1200">
          <h1>Our Vision</h1>
          <p>
      ...
      <div class="aboutus-item">
        <div class="aboutus-description-right" data-aos="fade-right" data-aos-delay="900">
            <h1>Our Mission</h1>
            <p>
        ...
        <div class="aboutus-img" data-aos="fade-left" data-aos-delay="1200">
          <img src="assets/img6.jpg" alt="">
        </div>
      </div>
      <div class="aboutus-item">
        <div class="aboutus-img ourvalues" data-aos="fade-right" data-aos-delay="900">
